...
router.get("/:id", (req, res) => {
  ...
  // Find the starred_restaurant with the matching id.
...
router.post("/", (req, res) => {
  ...
  // If the restaurant isn't on the list, let the client know.
  if (!restaurant) {
    res.sendStatus(404);
    return;
  }
...
router.delete("/:id", (req, res) => {
  ...
  if ( STARRED_RESTAURANTS === newListOfStarredRestaurants.length) {
    res.sendStatus(404);
    return;
  }
